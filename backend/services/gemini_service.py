"""
services/gemini_service.py — Google Gemini AI integration for legal analysis
"""
import json
import re
...
def _parse_response(raw: str, text: str) -> AnalyzeResult:
    """Parse Gemini's JSON response into AnalyzeResult."""
...
async def analyze_document(text: str, options: AnalyzeOptions) -> AnalyzeResult:
    """
    Send document to Google Gemini AI and return structured analysis.
    """
